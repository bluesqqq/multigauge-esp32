...
namespace Values {
    ...
    class Value {
        private:
            ...
            const Units::UnitType& unitType;

        public:
            Value(const char* name, const Units::UnitType& unitType, float minimumValue, float maximumValue);
            ...
            const Units::UnitType& getUnitType() const;
